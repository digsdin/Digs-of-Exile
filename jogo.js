...
// ========================================================================
function initializeGame(characterType) { let startHealth = 100, startSpeed = 3, startProjectileSpeed = 5, startAttackCooldown = 35, startDamage = 25, startCollectionRadius = 50; switch (characterType) { case 'gladiator': startHealth = 140; startSpeed = 2.8; startAttackCooldown = 40; break; case 'witch': startHealth = 80; startProjectileSpeed = 6; startAttackCooldown = 30; startCollectionRadius = 70; break; case 'ranger': startSpeed = 3.5; startDamage = 20; startAttackCooldown = 30; break; } player = new Player(canvas.width / 2, canvas.height / 2, 15, 'cyan'); player.maxHealth = startHealth; player.health = startHealth; player.speed = startSpeed; player.projectileSpeed = startProjectileSpeed; player.attackCooldown = startAttackCooldown; player.damage = startDamage; player.collectionRadius = startCollectionRadius; startScreen.classList.add('hidden'); canvas.classList.remove('hidden'); gameState = 'wave_transition'; animate(); }
